...
CREATE TABLE Actions (
	...
	ActionType_NUM smallint NOT NULL,
...
CREATE TABLE Campaigns (
	...
	CampaignType_ID smallint NOT NULL default '0',
	OwnerProfile_ID int DEFAULT '1' NOT NULL
);
...
CREATE TABLE Catalog (
	...
	ItemStatus_NUM smallint NOT NULL,
	ItemOrder_NUM int NULL,
	ItemViewed_NUM int NOT NULL,
...
CREATE TABLE Catalog_Values_Extra (
	...
	Item_ID int NOT NULL,
	Instance_ID int NOT NULL,
	FieldValueExtra_BLOB text NULL
);
...
CREATE TABLE Categories (
	...
	BaseCategory_ID int NOT NULL,
	CategoryDescription_STRING varchar(255) NOT NULL,
	CategoryStatus_NUM smallint NOT NULL,
	CategoryOrder_NUM int NOT NULL,
	TeaserTitle_STRING varchar(255) NOT NULL,
	Teaser_PIC varchar(255) NOT NULL,
	Teaser_BLOB text NULL,
	FullTitle_STRING varchar(255) NOT NULL,
	Full_PIC varchar(255) NOT NULL,
	Full_BLOB text NULL,
	AccessLevel_NUM smallint DEFAULT '-2' NOT NULL,
	OwnerProfile_ID int DEFAULT '1' NULL,
...
CREATE TABLE Components (
	...
	ShowTop_NUM smallint NOT NULL,
	ShowBottom_NUM smallint NOT NULL,
	ShowLeft_NUM smallint NOT NULL,
	ShowMiddle_NUM smallint NOT NULL,
	ShowRight_NUM smallint NOT NULL,
	RendersText_NUM smallint DEFAULT '1' NOT NULL,
	RendersHTML_NUM smallint DEFAULT '1' NOT NULL,
	ConfigFile_STRING varchar(100) NOT NULL,
	ConfigWidth_NUM smallint NOT NULL,
	ConfigHeight_NUM smallint NOT NULL
);
...
CREATE TABLE Containers (
	...
	ContainerType_NUM smallint NOT NULL,
	ContainerPosition_CHAR char(2) NOT NULL,
	ContainerOrder_NUM smallint NOT NULL,
	ContentTitle_STRING varchar(255) NOT NULL,
	Content_BLOB text NULL,
...
CREATE TABLE Content (
	...
	ContentVersion_NUM smallint NOT NULL,
	ContentType_STRING varchar(50) NOT NULL,
	...
	Full_PIC varchar(255) NOT NULL,
	Full_BLOB text NULL,
	Page_NUM smallint DEFAULT '1' NOT NULL,
	OwnerProfile_ID int DEFAULT '1' NOT NULL,
	Status_NUM smallint NOT NULL,
...
CREATE TABLE Countries_IP (
	...
	IPTo_NUM bigint NOT NULL default '0' PRIMARY KEY,
...
CREATE TABLE Errors (
	Error_NUM int NOT NULL PRIMARY KEY,
...
CREATE TABLE Forms (
	...
	FieldStatus_NUM smallint NOT NULL,
	FieldOrder_NUM smallint NOT NULL,
	FieldMandatory_NUM smallint NOT NULL,
	FieldMandatoryError_STRING varchar(255) NOT NULL default '',
	FieldValidationType_NUM smallint NOT NULL default '0',
	FieldHelp_STRING varchar(255) NOT NULL default '',
	FieldIdentifier_STRING varchar(50) NULL,
	ValueForm_ID int DEFAULT '-1' NOT NULL
);
...
CREATE TABLE Forms_Mails (
	...
	Form_ID int NOT NULL,
	FieldValue_STRING varchar(255) NOT NULL,
	LineCount_NUM smallint DEFAULT '0' NOT NULL
);
...
CREATE TABLE Forms_Paths (
	Item_ID int NOT NULL,
	PathDefinition_NUM int NOT NULL,
	Form_ID int NOT NULL,
	FieldValue_STRING varchar(255) NOT NULL,
	LineCount_NUM smallint DEFAULT '0' NOT NULL
);
...
CREATE TABLE Forms_Paths_Details (
	...
	PathDisabled_NUM smallint DEFAULT '0' NOT NULL
);
...
CREATE TABLE Forms_Rules (
	Rule_ID int NOT NULL,
	RuleDefinition_NUM int NOT NULL,
	Form_ID int NOT NULL,
	FieldValue_STRING varchar(255) NOT NULL,
	LineCount_NUM smallint DEFAULT '0' NOT NULL
);
...
CREATE TABLE Forms_Views_Definitions (
	Item_ID int NOT NULL,
	ViewDefinition_NUM int NOT NULL,
	ViewInclExcl_NUM smallint NOT NULL,
	ViewDefinitionCode_CHAR varchar(2) NOT NULL,
	ViewDefinitionSequence_NUM smallint NOT NULL,
...
CREATE TABLE Forms_Views_Details (
	...
	ViewDisabled_NUM smallint DEFAULT '0' NOT NULL
);
...
CREATE TABLE Instance (
	Instance_ID int NOT NULL IDENTITY (1, 1) PRIMARY KEY,
...
CREATE TABLE Mails (
	...
	MailText_STRING text NULL,
	MailHTML_STRING text NULL,
	OfflineImages_NUM smallint NOT NULL,
	Priority_NUM smallint NOT NULL,
	...
	SendVolume_NUM int NOT NULL,
	OpenVolume_NUM int NOT NULL,
	BouncedVolume_NUM int NOT NULL,
	CurrentStatus_NUM smallint NOT NULL
);
...
CREATE TABLE Mails_Mode (
	Mail_ID int NOT NULL,
	PageMode_NUM smallint NOT NULL,
	PageStyleSheet_STRING varchar(255) NOT NULL default ''
);
...
CREATE TABLE Media (
	...
	MediaStatus_NUM smallint NOT NULL,
	Filename_STRING varchar(255) NOT NULL,
	ContentType_STRING varchar(255) NOT NULL,
	AltText_STRING varchar(255) NOT NULL,
	Link_URL varchar(255) NOT NULL,
	HPosition_NUM smallint NOT NULL,
	VPosition_NUM smallint NOT NULL,
	WSize_NUM smallint NOT NULL,
	HSize_NUM smallint NOT NULL,
	...
	DisplayFrequency_NUM int NOT NULL,
	DisplayCount_NUM int NOT NULL
);
...
CREATE TABLE Messages (
	...
	BaseMessage_ID int NOT NULL,
	Item_ID int NOT NULL,
	Folder_ID int NOT NULL,
	FromProfile_ID int NOT NULL,
	ToProfile_ID int NOT NULL,
	MessageSubject_STRING varchar(255) NOT NULL,
	MessageBody_STRING text NULL,
	MessageStatus_NUM smallint NOT NULL,
	MessageViewed_NUM int NOT NULL,
...
CREATE TABLE OAuth_Permissions (
	...
	PermissionClass_NUM smallint NOT NULL DEFAULT '0',
	PermissionLevel_NUM smallint NOT NULL DEFAULT '0',
	Expiry_DATE datetime NULL
);
CREATE INDEX OAuth_PermissionsProfile_ID ON OAuth_Permissions (Profile_ID);
CREATE INDEX OAuth_PermissionsService_ID ON OAuth_Permissions (Service_ID);
...
CREATE TABLE Options (
	...
	OptionOrder_NUM smallint NOT NULL,
	Action_STRING varchar(255) NOT NULL
);
...
CREATE TABLE Permissions (
	Profile_ID int NOT NULL,
	Group_ID int NOT NULL,
	Category_ID int DEFAULT '-99' NOT NULL,
	PermissionClass_NUM smallint NOT NULL,
	PermissionLevel_NUM smallint NOT NULL,
	Expiry_DATE datetime NOT NULL
);
...
CREATE TABLE Profiles (
	...
	KeepAlive_NUM smallint NOT NULL,
	FirstVisit_DATE datetime NOT NULL,
	PreviousVisit_DATE datetime NULL,
	LastVisit_DATE datetime NOT NULL,
	Expiry_DATE datetime NOT NULL,
	Visits_NUM int NOT NULL,
	Status_NUM smallint NOT NULL,
	LoyaltyPoints_NUM int NOT NULL,
	...
	LastSupportsJava_NUM smallint NOT NULL,
	LastSupportsJavascript_NUM smallint NOT NULL,
	LastSupportsFlash_NUM smallint NOT NULL,
	LastSupportsFlashVersion_NUM float NOT NULL,
	LastScreenWidth_NUM smallint NOT NULL,
	LastScreenHeight_NUM smallint NOT NULL,
	LastBrowserWidth_NUM smallint NOT NULL,
	LastBrowserHeight_NUM smallint NOT NULL,
	LastPixelDepth_NUM smallint NOT NULL,
	LastBrowserTimezone_NUM smallint NOT NULL
);
...
CREATE TABLE Profiles_History (
	...
	RefererType_NUM smallint NOT NULL,
	RefererSearchTerms_STRING varchar(255) NOT NULL,
	RefererHost_STRING varchar(255) NOT NULL,
	LastAcceptsCookies_NUM smallint NOT NULL,
	LastSupportsJava_NUM smallint NULL,
	LastSupportsJavascript_NUM smallint NULL,
	LastSupportsFlash_NUM smallint NULL,
	LastSupportsFlashVersion_NUM float NULL,
	LastScreenWidth_NUM smallint NULL,
	LastScreenHeight_NUM smallint NULL,
	LastBrowserWidth_NUM smallint NULL,
	LastBrowserHeight_NUM smallint NULL,
	LastPixelDepth_NUM smallint NULL,
	LastBrowserTimezone_NUM smallint NULL,
...
CREATE TABLE Redirects (
	...
	RedirectDisabled_NUM smallint NOT NULL DEFAULT '0'
);
CREATE INDEX RedirectsRedirectPath ON Redirects (RedirectPath_STRING);
...
CREATE TABLE Reference (
	Reference_ID int NOT NULL IDENTITY (1, 1) PRIMARY KEY,
...
CREATE TABLE Rules (
	...
	RuleGroup_ID int NOT NULL default '0',
	RuleDescription_STRING varchar(255) NOT NULL,
	RuleDisabled_NUM smallint DEFAULT '0' NOT NULL,
...
CREATE INDEX StreamsFromService ON Streams (FromService_ID);
...
CREATE TABLE Streams_Tags (
	Tag_ID bigint NOT NULL IDENTITY (1, 1) PRIMARY KEY,
...
CREATE TABLE Templates (
	...
	TemplateType_NUM smallint NOT NULL,
...
CREATE TABLE Triggers (
	Trigger_ID int NOT NULL IDENTITY (1, 1) PRIMARY KEY,
	...
	RemoveAfter_NUM smallint NOT NULL,
	Action_STRING varchar(255) NOT NULL,
...
INSERT INTO Categories (Category_ID, BaseCategory_ID, CategoryDescription_STRING, CategoryStatus_NUM, CategoryOrder_NUM, TeaserTitle_STRING, Teaser_PIC, Teaser_BLOB, FullTitle_STRING, Full_PIC, Full_BLOB, AccessLevel_NUM, OwnerProfile_ID) VALUES ('0', '-1', 'Home', '1', '0', '', '', '', '', '', '', '-2', '1');
...
INSERT INTO Profiles (Profile_ID, Login_STRING, Password_STRING, UserName_STRING, KeepAlive_NUM, FirstVisit_DATE, PreviousVisit_DATE, LastVisit_DATE, Expiry_DATE, Visits_NUM, Status_NUM, LoyaltyPoints_NUM, LastIP_STRING, LastAgent_STRING, LastLanguage_STRING, LastReferer_STRING) VALUES (1, 'root.user', '12345678', 'Webmaster', '0', CONVERT(datetime, ''), CONVERT(datetime, ''), CONVERT(datetime, ''), CONVERT(datetime, ''), '0', 100, '0', '', '', '', '');
...
INSERT INTO Catalog (Item_ID, Category_ID, ItemCode_STRING, ItemType_CHAR, ItemStatus_NUM, ItemOrder_NUM, ItemViewed_NUM, Entry_DATE, LastModified_DATE, Expiry_DATE) VALUES ('1', '0', 'Document', 'T', '0', '0', '0', CONVERT(datetime, ''), CONVERT(datetime, ''), CONVERT(datetime, ''));
...
SET IDENTITY_INSERT Catalog ON;
INSERT INTO Catalog (Item_ID, Category_ID, ItemCode_STRING, ItemType_CHAR, ItemStatus_NUM, ItemOrder_NUM, ItemViewed_NUM, Entry_DATE, LastModified_DATE, Expiry_DATE) VALUES ('2', '0', 'Product', 'T', '1', '0', '0', CONVERT(datetime, ''), CONVERT(datetime, ''), CONVERT(datetime, ''));
SET IDENTITY_INSERT Catalog OFF;
SET IDENTITY_INSERT Forms ON;
