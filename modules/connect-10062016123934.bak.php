...
define ("FriendlyName", "client_name"); //--- Don't change manually, rather use the setup program
define ("ThisURL", "http://" . $_SERVER['HTTP_HOST']);
define ("CookieDomain", "");

//--- Default e-mails
define ("Webmaster", "webmaster_email");
define ("MailBot", "mailbot_name");
...
define ("DOCUMENT_ROOT", "/mnt/data/apache/htdocs/vhosts/document_root");
...
if (defined ("DB_INCLUDED")) {
	ConnectToDB ("127.0.0.1", None, "default_database", "default_db_user", "default_db_password");
}
?>
