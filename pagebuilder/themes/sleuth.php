...
$ContainerTypes = array (
	1 => array ("Name" => "Container 1 [standard border, standard header]", "Style" => "1", "Border" => "0", "CellPadding" => "0", "CellSpacing" => "0", "ShowTitle" => "0", "ShowFooter" => "0"),
	2 => array ("Name" => "Container 2 [standard border, standard header]", "Style" => "1", "Border" => "0", "CellPadding" => "0", "CellSpacing" => "0", "ShowTitle" => "1", "ShowFooter" => "0"),
	...
	5 => array ("Name" => "Container 5 [standard border, standard header]", "Style" => "0", "Border" => "0", "CellPadding" => "5", "CellSpacing" => "0", "ShowTitle" => "0", "ShowFooter" => "0"),
	6 => array ("Name" => "No border, no header", "Style" => "0", "Border" => "0", "CellPadding" => "0", "CellSpacing" => "0", "ShowTitle" => "1", "ShowFooter" => "1")
);
?>