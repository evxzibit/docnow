...
$ContainerTypes = array (
	1 => array ("Name" => "Black, enhanced border", "Style" => 1, "Border" => 0, "CellPadding" => 0, "CellSpacing" => 0, "ShowTitle" => 1, "ShowFooter" => 0),
	2 => array ("Name" => "Black, enhanced border with purple title", "Style" => 1, "Border" => 0, "CellPadding" => 0, "CellSpacing" => 0, "ShowTitle" => 1, "ShowFooter" => 0),
	3 => array ("Name" => "Black, enhanced border / no title", "Style" => "1", "Border" => "0", "CellPadding" => "0", "CellSpacing" => "0", "ShowTitle" => "0", "ShowFooter" => "0"),
