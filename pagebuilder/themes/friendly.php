...
$ContainerTypes = array (
	...
	2 => array ("Name" => "Standard container, small black heading", "Style" => "0", "Border" => "0", "CellPadding" => "5", "CellSpacing" => "0", "ShowTitle" => "1", "ShowFooter" => "0"),
	...
	6 => array ("Name" => "No border, no header", "Style" => "0", "Border" => "0", "CellPadding" => "0", "CellSpacing" => "0", "ShowTitle" => "0", "ShowFooter" => "0")
);
?>